...
class ChangeDataView(ttk.Toplevel):
    def __init__(self,master,data_selected):
        super().__init__(master)
        __data_selected = data_selected
    ...
    def widgets(self):
        ...
        self.add_button = ttk.Button(bottom_frame, text="VALIDER", command=self.validate,
                                     style="ValidateButton.TButton")
        self.cancel_button = ttk.Button(bottom_frame, text="ANNULER", command=self.destroy,
